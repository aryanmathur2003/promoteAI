    ...
    <div class="bg-gray-100 p-3 flex items-center justify-center">
        <div class="bg-white border shadow-sm px-4 py-3 rounded-lg max-w-lg">
            <div class="flex items-center">
                <img class="h-12 w-12 rounded-full" src={profilePicture}/>
            <div class="ml-2">
        <div class="text-sm ">
          <span class="font-semibold">{username}</span>
          <span class="text-gray-500"> • 1st</span>
        </div>
        <div class="text-gray-500 text-xs ">Mission drivin company </div>
        <div class="text-gray-500 text-xs flex">
          <span class="inline-block">3d • Edited • </span>
          <svg class="inline-block ml-1 fill-current mercado-match" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" data-supported-dps="16x16" fill="currentColor" width="16" height="16" focusable="false">
